...
class App(customtkinter.CTk):
    ...
    def btn_pedir_clave_on_click(self):
        contraseña= prompt("Inicio de sesión", "Ingrese la contraseña")

        while(contraseña!= "utn750"):
            contraseña= prompt("Inicio de sesión inválido", "Reingrese la contraseña")

        alert(title="Inicio de sesión", message= "Bienvenido")
