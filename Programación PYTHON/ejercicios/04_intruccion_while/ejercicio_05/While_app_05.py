...
class App(customtkinter.CTk):
    ...
    def btn_validar_letra_on_click(self):
        letra= prompt("Ingrese una letra","Ingrese una letra")

        while letra!="U" and letra!="T" and letra!="N":
            letra=prompt("Incorrecto","Reingrese una letra correcta")
            
        alert(title="Letra ingresada", message= "La letra ingresada es "+letra)
