...
class App(customtkinter.CTk):
    ...
    def btn_validar_on_click(self):
       ...
       while edad < 17 or edad > 90:
           edad= int(prompt("Edad incorrecta", "Reingrese una edad válida"))
       ...
       while estado_civil!= "Soltero/a" and estado_civil!= "Casado/a" and estado_civil!= "Divorciado/a" and estado_civil!="Viudo/a":
           estado_civil=prompt("Estado Civil incorrecto", "Vuelva a ingresar su Estado Civil")
        
       self.combobox_tipo.set(estado_civil)
       
       legajo= int(prompt("Legajo", "Ingrese su número de legajo"))

       while legajo < 999:
           legajo= int(prompt("Número incorrecto", "Ingrese un número de legajo de 4 cifras"))
